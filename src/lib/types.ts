...
export interface CustomerLocation {
  ...
  loyalty_banner_text: string | null;
  loyalty_banner_text_en: string | null;
  loyalty_banner_text_de: string | null;
